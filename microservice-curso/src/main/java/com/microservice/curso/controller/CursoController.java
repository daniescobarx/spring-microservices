...
public class CursoController {
    ...
    @GetMapping("/search-aluno/{cursoId}")
    public ResponseEntity<?> findAlunoBycursoId(@PathVariable Long cursoId){
        return ResponseEntity.ok(cursoService.findAlunosBycursoId(cursoId));
    }
